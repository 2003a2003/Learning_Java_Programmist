package lesson8.part_02.frame_04;
...
public class CreateDirAndFileCopyFile {
    ...
    public static void main(String[] args) throws IOException {
        String dirName = "directory01";
        String part = "src/lesson8/part_02/frame_04/";
...
//        copyFile(file);
        ...
        InputStream in = new FileInputStream(getRelativeFileDir(filePart + "/" + fileName));
        printStreemData(in);
