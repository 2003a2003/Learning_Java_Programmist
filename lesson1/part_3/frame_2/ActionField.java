...
//
//        bl.setBulletX(tank.getTankX() + 25);
//        bl.setBulletY(tank.getTankY() + 25);
//        // -14 sizeButlles
//
//        while (bl.getBulletY() > -14 && bl.getBulletY() < bf.getBF_HEIGHT() && bl.getBulletX() > -14 && bl.getBulletX() < bf.getBF_WIDTH()) {
//
//            if (tank.getTankDirection() == MOVE_UP) {
//                bl.setBulletY(bl.getBulletY() - bl.getButlleStep());
//            } else if (tank.getTankDirection() == MOVE_DOWN) {
//                bl.setBulletY(bl.getBulletY() + bl.getButlleStep());
//            } else if (tank.getTankDirection() == MOVE_LEFT) {
//               bl.setBulletX(bl.getBulletX() - bl.getButlleStep());
//            } else if (tank.getTankDirection() == MOVE_RIGHT) {
//                bl.setBulletX(bl.getBulletX() + bl.getButlleStep());
//            }
//
//            if (processInterception(bl.getBulletX(), bl.getBulletY())) {
//                bl.setBulletX(-100);
//                bl.setBulletY(-100);
//            }
//
//            repaint();
//            Thread.sleep(bl.getBulletSpeed());
//        }
//    }
//
...
//        g.fillRect(bl.getBulletX(), bl.getBulletY(), 14, 14);
//    }
//}
