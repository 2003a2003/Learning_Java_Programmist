...
//        tankDef.moveRandom();
    ...
    public void clean() throws Exception {
        ...
        if (x != bf.getMIN_QUADRANT_COORDINATE() || y != bf.getMIN_QUADRANT_COORDINATE()){
           tankDef.moveToQuadrant(y,x);
        }

        for (; y-1 < 9;){
            tankDef.turn(MOVE_RIGHT);
            clenLeftRight(x-1,y-1);

            if(y == 1) {
                tankDef.turn(MOVE_DOWN);
                clenLeftRight(x - 1, y - 1);
            }
    ...
    private boolean clenLeftRight(int x, int y) throws Exception{
    ...
    public void checkQuadrant(int direction) throws Exception {
    ...
    public ActionField() throws Exception {
        ...
        bf = new BattleField();
        tankDef = new Tank(this, bf, 0, 1*64, 2);
        bullet = new Bullet();
